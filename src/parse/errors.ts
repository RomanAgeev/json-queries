...
export const handleErrors = (results: (JsonIterator | JsonParseError[])[]): { iterators: JsonIterator[], errors: JsonParseError[] } =>
    results.reduce((acc: { iterators: JsonIterator[], errors: JsonParseError[] }, result) =>
